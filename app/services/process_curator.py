...
from app.api_config import TOP_N_ARTICLES
...
def curate_digests(hours: int = 168) -> dict:  # 168 hours = 7 days
    """
    Curate and rank digests using AI.
    
    Note: This uses 1 API call to rank ALL articles at once.
    """
    ...
    logger.info(f"⚠️  API calls for this run: 1 (CuratorAgent ranks all at once)")
...
if __name__ == "__main__":
    result = curate_digests(hours=168)  # 7 days
    print(f"\n=== Curation Results ===")
